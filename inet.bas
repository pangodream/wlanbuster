...
Private Sub SocketsCleanup()
   ...
   If WSACleanup() <> 0 Then
       Debug.Print "Windows Sockets error occurred in Cleanup."
   End If
     ...
     'convert string address to long
      ...
      If hAddress <> SOCKET_ERROR Then
        ...
        'corresponding to the given network address.
         ...
         Else
            Debug.Print "Call to gethostbyaddr failed."
         End If 'If ptrHosent
      
      SocketsCleanup
      
      Else
         Debug.Print "String passed is an invalid IP."
      End If 'If hAddress
   
   Else
      Debug.Print "Sockets failed to initialize."
